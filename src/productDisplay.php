...
class Product
{
    ...
    foreach($this->listproducts as $rows => $key){
		...
		<div class="card mb-4 box-shadow" style="width:400px">
            <img class="card-img-top" style="max-width: 500px; max-height:400px; min-height:400px;" src="',$key['PhotoProduit'],'">
            <div class="card-body">
				<p class="card-text">',$key['NomProduit'],'</p>
                <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
						<a href=\'./product.php?id=',$key['IDProduit'],'\'>
						<button type="button" class="btn btn-sm btn-outline-secondary">Voir</button></a>						
                    </div>
